...
def calculates_results_stats(results_dic):
    ...
    """        
    results_stats_dic = {
        'n_images': len(results_dic), # total number of dog images
        ...
        'n_correct_breed': 0, # number of correctly classified dog breeds OK
    ...
    for result in results_dic.values():
        ...
        if correct_match:
            ...
            # Breed match if image is also a dog
            if pet_image_is_dog:
        ...
        if pet_image_is_dog:
            ...
            # Is a correct dog match (regardless of breed)
            # if the classifier image is also a dog
            if classifier_image_is_dog:
        ...
        # Is not a dog image
            ...
            # Is a correct non-dog match if classifier image is also NOT a dog
            if not classifier_image_is_dog:
