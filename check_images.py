...
def formatted_time(seconds):
    """Returns time as a string formatted to HH:MM:SS given a number of seconds
    """
    
    """
    Args: seconds (int)
    
    Returns: time as a string formatted HH:MM:SS
    """
    ...
    return "{}:{}:{}".format(str(hours), str(minutes), str(remaining_seconds))
